            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('app.candidate.update', $candidate->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="sub_order">Sub Order</label>
                            <input type="text" name="sub_order" id="sub_order"
                                class="form-control @error('sub_order') is-invalid @enderror" value="{{ old('sub_order',$candidate->sub_order) }}"
                                placeholder="Enter Sub Order">
                            @error('sub_order')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
