...
class CandidateController extends Controller implements HasMiddleware
{
    ...
    public function store(CandidateStoreRequest $request)
    {
        try {
            ...
            return back()->withErrors(['error'=> 'Failde to create account' . $e->getMessage()]);
        }
    }
    ...
    public function update(CandidateUpdateRequest $request, string $id)
    {
        try {
            ...
            return back()->withErrors(['error'=> 'Failde to updated candidate' . $e->getMessage()]);
        }
    }
    ...
    public function destroy(string $id)
    {
         try {
            ...
            Candidate::where('sub_order', '>', $candidate->sub_order)->decrement('sub_order');
